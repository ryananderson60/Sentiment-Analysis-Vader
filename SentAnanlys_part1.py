...
class VoteClassifier(ClassifierI):
    ...
    def classify(self, features):
         ...
         for c in self._classifiers:
             ...
             votes.append(v)
         return mode(votes) #python 2.7 use: stats.mode(votes)
    def confidence(self, features):
         ...
         #python 2.7 use: stats.mode(votes)
...
print("SGDClassifier accuracypercent:",nltk.classify.accuracy(SGDC_classifier,
testing_set)*100)
